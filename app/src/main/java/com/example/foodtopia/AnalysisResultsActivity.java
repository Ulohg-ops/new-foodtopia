...
public class AnalysisResultsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Spinner的Adapter
        ArrayAdapter adapter1 = ArrayAdapter.createFromResource(AnalysisResultsActivity.this
    ...
    public void launch_countdown(){
        new CountDownTimer(4000, 2500) {
            ...
            public void onTick(long millisUntilFinished) {
                Toast.makeText(AnalysisResultsActivity.this,"稍待片刻",Toast.LENGTH_SHORT).show();
            }
    ...
    private void fetchData(String ingr) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                Looper.prepare();
                Toast.makeText(AnalysisResultsActivity.this, "Error"+e,
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()){
                    ...
                    AnalysisResultsActivity.this.runOnUiThread(() -> {
                        try {
    ...
    private void upload(){
        ...
        //設定餐點資料
        Diet diet = new Diet(name,amount,amountQuantifier,kcal,carbohydrate,fat,mealtime,
